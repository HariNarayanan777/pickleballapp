    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (config.getStartForeground()) {
          ...
          if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String id_channel = "backgroud1bgloc";
            NotificationChannel channel = new NotificationChannel(id_channel, "bgloc", NotificationManager.IMPORTANCE_HIGH);
            NotificationManager notificationManager = getSystemService(NotificationManager.class);
            notificationManager.createNotificationChannel(channel);
            builder = new NotificationCompat.Builder(this, id_channel);
          } else {
